...
from PolicyHandler import whenever결재됨_주문접수
from PolicyHandler import whenever취소됨_취소알림
from PolicyHandler import whenever배송확인_배송확인완료
...
def consume(msg):
    ...
    if data['eventType'] == "결재됨":
        whenever결재됨_주문접수(data)
    if data['eventType'] == "취소됨":
        whenever취소됨_취소알림(data)
    if data['eventType'] == "배송확인":
        whenever배송확인_배송확인완료(data)
